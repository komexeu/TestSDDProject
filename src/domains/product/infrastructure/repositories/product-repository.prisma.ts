...
import { IProductRepository, IProductQueryRepository } from '../../domain/repositories/product-repository';
import { Product, ProductId } from '../../domain/entities/product';
import { ProductName } from '../../domain/value-objects/product-properties';
